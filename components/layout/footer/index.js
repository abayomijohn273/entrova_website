...
const Footer = () => {
    return <footer className='relative'>
        <div className="container px-4 mx-auto pt-6 lg:pt-8 border-t border-[#E6E6E6]">
            <div className="pb-14 lg:pb-16 w-full flex flex-col lg:flex-row justify-between items-center">
                <div>
                    <Animate.Fade bottom>
                        <p className='text-sm lg:text-sm text-primary mx-auto lg:mx-0 w-10/12 lg:w-full lg:text-left text-center'>
                ...
                <div className='mt-8 lg:mt-0'>
                    <Animate.Fade bottom>
                        <div className='flex flex-col lg:flex-row'>
                            <div className="flex flex-row justify-center lg:justify-end items-center space-x-6 lg:space-x-3">
                            <a
