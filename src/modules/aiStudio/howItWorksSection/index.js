    ...
    return (
        <section id="about" className={`relative bg-[#EFF6FF] pt-[7.5rem]`}>
            <div className='container px-4 lg:px-0 xl:px-8 2xl:px-0 mx-auto pb-[5rem] lg:pb-[8.938rem]'>
                <p className='text-base font-medium text-[#84CC16] uppercase'>
                AI Capabilities
                </p>
                ...
                <p className="w-full md:w-8/12 lg:w-6/12 xl:w-5/12 mt-4 text-[#1E1E1E] text-base">
                    From the first proof-of-concept to a production system handling real traffic, we cover
                    the full AI lifecycle—data, models, infrastructure, and the product experience around them.
                </p>
                ...
                <div className="mt-[40px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <Card
                        ...
                        description={`Chatbots, copilots, and RAG systems built on the latest foundation models.`}
                    />
                    <Card
                        icon={<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        description={`Predictive models, recommendation engines, and computer vision tailored to your data.`}
                    />
                    <Card
                        icon={<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        title={"AI Automation"}
                        description={`Streamline workflows with intelligent agents and end-to-end pipelines.`}
                    />
                </div>
            </div>
        </section>
