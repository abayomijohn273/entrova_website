        ...
        <section id="about" className={`relative bg-[#EFF6FF] pt-[7.5rem]`}>
            <div className='container px-4 lg:px-0 xl:px-8 2xl:px-0 mx-auto pb-[5rem] lg:pb-[8.938rem]'>
                ...
                <p className="w-full md:w-8/12 lg:w-6/12 xl:w-5/12 mt-4 text-[#1E1E1E] text-base">
                    With Entrova, you get a platform that streamlines hiring, compliance, and payments
                    for international talent, ensuring you focus on growth while we handle the complexities.
                </p>
                ...
                <div className="mt-[40px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <Card
                        ...
                        title={"120+ Countries Supported"}
                        description={`Build your dream global team without worrying about regulations.`}
                    />
                    <Card
                        icon={<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        description={`Save up to 80% on hiring costs with our AI-driven platform.`}
                    />
                    <Card
                        icon={<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        description={`Hire in days, not weeks—scale your team faster.`}
                    />
                </div>
            </div>
        </section>
