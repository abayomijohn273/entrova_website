        ...
        <section id="about" className={`relative bg-[#EFF6FF] pt-[7.5rem]`}>
            <div className='container px-4 lg:px-0 xl:px-8 2xl:px-0 mx-auto pb-[5rem] lg:pb-[8.938rem]'>
                ...
                <p className='w-full md:w-8/12 lg:w-6/12 xl:w-5/12 text-primary font-bold text-[28px] leading-[38px]'>
                    We handle the engineering, you focus on growth
                </p>

                <p className="w-full md:w-8/12 lg:w-6/12 xl:w-5/12 mt-4 text-[#1E1E1E] text-base">
                    Building great software takes the right team, process,
                    and tools. We bring all three—delivering reliable,
                    well-architected products across the full stack so you
                ...
                <div className="mt-[40px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <Card
                        ...
                        description={`Fast, responsive applications built with modern
                    frameworks like React, Next.js, and React Native—crafted
                    for performance and great UX.`}
                    />
                    <Card
                        icon={<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        title={"Cloud & DevOps"}
                        description={`Scalable cloud infrastructure, CI/CD pipelines, and 
                        reliable deployments on AWS, GCP, and Azure.`}
                    />
                     <Card
                        icon={<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        description={`Intuitive, beautiful interfaces grounded in user 
                        research, prototyping, and design-system best practices.`}
                    />
                </div>
            </div>
        </section>
