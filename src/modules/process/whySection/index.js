        ...
        <section id="about" className={`relative bg-white pt-[7.5rem]`}>
            <div className='container px-4 lg:px-0 xl:px-8 2xl:px-0 mx-auto pb-[5rem] lg:pb-[8.938rem]'>
                ...
                <p className='mt-4 w-full md:w-8/12 lg:w-6/12 xl:w-5/12 text-primary font-bold text-[28px] leading-[38px]'>
                    The engineering principles we live by on every project.
                </p>
                ...
                <div className="mt-[40px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <Card
                        ...
                        description={`Shared boards, regular demos, and direct access to the team—you always know what's happening.`}
                    />
                    <Card
                        icon={<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        description={`Well-structured, documented, and tested code you can confidently build on for years.`}
                    />
                    <Card
                        icon={<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        description={`Security best practices, monitoring, and resilience are designed into every system from the start.`}
                    />
                </div>
            </div>
        </section>
