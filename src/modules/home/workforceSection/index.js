...
const WorkforceSection = () => {
    return (
        <section id="about" className={`relative bg-[#F3F3F3] pt-[5.875rem] md:pt-[7.5rem]`}>
            <div className='container px-4 lg:px-0 xl:px-8 2xl:px-0 mx-auto pb-[5rem] lg:pb-[8.938rem]'>
                <div className='flex justify-between items-end'>
                    ...
                    <div className='w-full md::w-6/12'>
                        <h2 className='text-primary font-bold text-[2.5rem] leading-[50.97px] md:text-[3.5rem] md:leading-[65px] lg:text-[4.5rem] lg:leading-[75px] xl:text-[5.5rem] xl:leading-[90px]'>
                            Workforce<br />
                            Management <br />
                            <span className='text-secondary'>Re-imagined.</span>
                        </h2>

                        <div className='mt-[2.125rem] flex flex-col md:flex-row md:items-center md:space-x-2 text-base text-[#656565] font-semibold'>
                            <p>FOR YOUR BUSINESS</p>
                            <div class="w-2 h-2 bg-secondary rounded-full hidden md:block"></div>
                        ...
                        <div className='mt-[2.5rem] md:mt-[2.438rem] w-full md:w-10/12 lg:w-9/12'>
                            <p className='text-primary text-base font-medium leading-7'>
                                We&apos;re making it easier for businesses around the world to manage their teams seamlessly. Our goal is to simplify global team
                                management so much that businesses can move forward confidently without any doubts. Join the future of people management today!
                            </p>
                        </div>
                    </div>
