        ...
        <div className='w-full mx-auto'>
          ...
          <div className="mt-14 md:mt-16 lg:mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card
              ...
              description={`We dig into your goals, users, and technical needs to shape a clear roadmap.`}
            />
            <Card
              icon={<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              title={"Design & Build"}
              description={`Rapid prototyping and agile sprints get you to a working product fast.`}
            />
            <Card
              icon={<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              title={"Launch & Scale"}
              description={`We ship, monitor, and iterate so your product keeps improving after launch.`}
            />
          </div>
        </div>
      </div>
