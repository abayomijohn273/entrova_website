...
import ContractorDashboardImage from "../../../../public/images/webp/contractor_dashboard.webp"
            ...
            <div className='container px-4 lg:px-0 xl:px-8 2xl:px-0 pb-[2rem] pt-[5.563rem] md:py-[6.25rem]  mx-auto'>
                <div className='relative grid grid-cols-1 lg:grid-cols-2 gap-x-6'>
                    <div className='w-full lg:w-11/12 xl:w-10/12'>
                        ...
                        {/* Desktop */}
                        <div className='mt-[5rem] hidden lg:flex justify-start'>
                            <Image src={ContractorDashboardImage} alt='Dashboard' className='w-fit' />
                        </div>
                    </div>
                ...
                <div className='mt-[4rem] lg:hidden flex justify-center'>
                    <Image src={ContractorDashboardImage} alt='Dashboard' className='w-auto' />
                </div>
            </div>
        </section>
    )
