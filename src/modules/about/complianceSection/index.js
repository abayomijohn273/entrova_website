            ...
            <div className='container px-4 lg:px-0 xl:px-8 2xl:px-0 mx-auto pb-[5rem] lg:pb-[8.938rem]'>
                ...
                <div className="mt-[40px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <Card
                        ...
                        title={"Senior, Distributed Team"}
                        description={`We work remotely across time zones with experienced people who get things done. `}
                    />
                    <Card
                        icon={<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        description={`We staff lean, focused squads so communication stays clear 
                    ...
                    <Card
                        ...
                        description={`We invest in research, experimentation, and continuous 
                        learning—especially in AI and emerging tech.`}
                    />
                </div>
            </div>
        </section>
