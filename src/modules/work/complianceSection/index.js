        ...
        <section id="about" className={`relative bg-white pt-[7.5rem]`}>
            <div className='container px-4 lg:px-0 xl:px-8 2xl:px-0 mx-auto pb-[5rem] lg:pb-[8.938rem]'>
                ...
                <p className="w-full md:w-8/12 lg:w-6/12 xl:w-5/12 mt-4 text-[#1E1E1E] text-base">
                    Every product we ship is backed by the same engineering rigor, modern tooling, and
                    attention to craft—so quality is never an afterthought.
                </p>
                ...
                <div className="mt-[40px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    <Card
                        ...
                        description={`React, Next.js, Node, Python, and React Native—chosen 
                        to fit each product and keep it fast and maintainable.`}
                    />
                    <Card
                        icon={<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        description={`Reusable component libraries and design systems that keep 
                        products consistent, accessible, and easy to evolve.`}
                    />
                    <Card
                        icon={<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        title={"Cloud & DevOps"}
                        description={`Containerized, automated deployments with CI/CD and 
                        observability built in for reliable releases.`}
                    />
                    <Card
                        icon={<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        description={`Automated testing, code reviews, and QA at every stage to 
                        ship software that's robust and dependable.`}
                    />
                </div>
            </div>
        </section>
