            ...
            <div className='container px-4 lg:px-0 xl:px-8 2xl:px-0 mx-auto pb-[5rem] lg:pb-[8.938rem]'>
                ...
                <div className="mt-[40px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <Card
                        ...
                        description={`Our proprietary AI companion identifies top talent from diverse markets with unmatched precision.`}
                    />
                    <Card
                        icon={<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Card
                        ...
                        description={`Entrova creates a direct pipeline for companies to access exceptional talent from Africa and other emerging markets, helping businesses scale while driving global economic inclusion.`}
                    />
                </div>
            </div>
        </section>
